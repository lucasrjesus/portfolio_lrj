          ...
          >
            ...
            <div className="flex items-center gap-8">
              ...
              <a
                ...
                id="contact-linkedin"
                className="flex items-center gap-2 text-sm font-mono text-[var(--text-muted)] border-b border-transparent pb-1 hover:border-[var(--text-muted)] hover:text-[var(--text-primary)] transition-all group"
              >
                <svg
